                ...
                <div class="card shadow">
                    ...
                    <div class="table-responsive card-body">
                        <form action="/payment/confirm" method="GET">
                            <input class="form-control" value="{{$data_order->video_id}}" type="text" hidden name="product_id" required>
                            <input class="form-control" value="{{$data_order->title}}" type="text" hidden name="product_title" required>
                            @if (AppHelper::getAuth())
                            <table class="table table-hover table-condensed">
                                <tr>
                                    <td>Tipe Produk</td>
                                    <td><input class="form-control" type="text" placeholder="Masukan nama" name="product_type" value="Module Video" required readonly></td>
                                </tr>
                                <tr>
                                    <td>Nama</td>
