        ...
        <div class="row">
                ...
                <div class="card shadow">
                    ...
                    <div class="table-responsive card-body">
                        <form action="/payment/confirm" method="GET">
                            <input class="form-control" value="{{$data_order->course_id}}" type="text" hidden name="product_id" required>
                            <input class="form-control" value="{{$data_order->course_name}}" type="text" hidden name="product_title" required>
                            @if (AppHelper::getAuth())
                            <table class="table table-hover table-condensed">
                                <tr>
                                    <td>Tipe Produk</td>
                                    <td><input class="form-control" type="text" placeholder="Masukan nama" name="product_type" value="Course" required readonly></td>
                                </tr>
                                <tr>
                                    <td>Nama</td>
            ...
            <div class="col-12 col-md-4">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Nama Produk :</p>
                        @if(isset($data_order->title))
                        <span class="text-right">{{$data_order->title}}</span>
                        @else
                        <span class="text-right">{{$data_order->course_name}}</span>
                        @endif
                        <hr/>
                        <p>Harga : </p>
